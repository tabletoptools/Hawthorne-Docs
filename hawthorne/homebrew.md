...
## Tier 2
 ...
 - [Tablets of Sending](#tablets-of-sending)
 - [Gutbuster](#gutbuster)
...
**Wondrous Item, T2 (requires attunement by a paladin)**  
...
**Weapon (Any weapon with the Thrown  property), T2/T2/T3 (requires attunement)**  
...
## Ring of Arbitration
**Wondrous Item, T2 (requires attunement)**  
...
**Wondrous Item, T1 (requires attunement)**  
...
**Weapon (Any), T2 (requires attunement)**  
...
## Crystal-core weapon
**Weapon (Any Melee), Legacy T1 (requires attunement)**  
...
## Slanderous Skullcap
**Wondrous Item, Legacy T1 (requires attunement)**  
...
**Weapon (Dagger), T3 (requires attunement)**  
...
## Ghostgrip Gauntlets
**Wondrous, T1 (requires attunement)**  
...
## Akrisae's War Mace
**Weapon (Mace), T2 (requires attunement by Cleric or Paladin)**  
...
## Delver's Dirk
**Weapon (Dagger), T1 (requires attunement)**  
...
## Fatestrike Weapon
**Weapon (Any kind), Legacy T1 (requires attunement)**  
...
## Bow of the Hunt
**Weapon (Any bow), T3 (requires attunement)**  
...
**Weapon (Shortsword), T2 (requires attunement)**  
...
## The Dawnstar
**Weapon (Morningstar), T2 (requires attunement by a Paladin)**  
...
## Rhahk'Zor's Hammer
**Weapon (Maul), T2 (requires attunement)**  
...
## Sun Lantern
**Lantern (Bullseye), T3 (requires attunement)**  
...
## Shadow Mist 
**Wonderous Item, T3 (Requires attunement)**  
...
## Cracker
**Weapon (Flail), T2 (requires attunement)**  
...
## Phoenix Armor
**Armor (Plate), T3 (requires attunement)**  
...
**Longbow, T3+ (requires attunement)**  
...
**Weapon (Halberd, Greataxe, Glaive), T3 (requires attunement)**  
...
## Firestorm Weapon
**Weapon (Any Weapon with the heavy and two-handed properties), T2 (requires attunement)**  
...
## Fortunate Shotgun
**Weapon (Shotgun or Scattergun), T2**  
...
## Crusader's Armanent
**Weapon (Any Weapon), T2 (requires attunement)**  
...
## Clover
**Weapon (Any Pistol), T2 (requires attunement)**  
...
## Conductor's Baton
**Wondrous Item, T2 (requires attunement by a bard)**  
...
## Fulguris
**Warhammer, T3 (requires attunement by a good creature)**  
...
## Orca Weapon
**Weapon (Any Ranged Weapon), T2 (requires attunement)**  
...
**Wondrous Item, T1 (requires attunement by a Paladin)**  
...
## Spider's Prey
**Hand Crossbow, T2 (requires attunement)**  
...
**Weapon (Any), T2/T2/T3/T4 (requires attunement by a bard)**  
